public class Zadanie {
    ...
    public static void main(String[] args) {
        System.out.println("Wyjątki dzielimy na dwie kategorie które trzeba obsłużyć i inne wyjatki które można, ale nie trzeba obsłużyć.\n" +
                ...
                "Wyjątki rzucamy korzystając z instrukcji tchrows, jeśli rzucamy wyjątek kontrolowany musimy dodatkowo w sygnaturze metody/konstruktora zadeklarować wyjątek używając słoa throw\n" +
